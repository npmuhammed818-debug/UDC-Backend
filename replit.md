...
- Required secret: `SUPABASE_DATABASE_URL` — Supabase transaction-mode pooler connection string
- Optional migration secret: `SUPABASE_DIRECT_URL` — Supabase session-mode pooler connection string
